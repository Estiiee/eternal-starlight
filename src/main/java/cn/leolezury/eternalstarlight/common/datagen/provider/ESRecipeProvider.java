package cn.leolezury.eternalstarlight.common.datagen.provider;
...
public class ESRecipeProvider extends RecipeProvider {
	...
	protected void buildRecipes(Consumer<FinishedRecipe> recipeOutput) {
		...
		// cooked food
		addCookingRecipes(recipeOutput, "smoking", RecipeSerializer.SMOKING_RECIPE, 100);
		addCookingRecipes(recipeOutput, "campfire_cooking", RecipeSerializer.CAMPFIRE_COOKING_RECIPE, 600);
		...
		new ManaCrystalRecipe(EternalStarlight.id("terra_crystal_special"), CraftingBookCategory.MISC, ManaType.TERRA, ESItems.TERRA_CRYSTAL.get()).save(recipeOutput, EternalStarlight.id("terra_crystal_special"));
		new ManaCrystalRecipe(EternalStarlight.id("wind_crystal_special"), CraftingBookCategory.MISC, ManaType.WIND, ESItems.WIND_CRYSTAL.get()).save(recipeOutput, EternalStarlight.id("wind_crystal_special"));
		new ManaCrystalRecipe(EternalStarlight.id("water_crystal_special"), CraftingBookCategory.MISC, ManaType.WATER, ESItems.WATER_CRYSTAL.get()).save(recipeOutput, EternalStarlight.id("water_crystal_special"));
		new ManaCrystalRecipe(EternalStarlight.id("lunar_crystal_special"), CraftingBookCategory.MISC, ManaType.LUNAR, ESItems.LUNAR_CRYSTAL.get()).save(recipeOutput, EternalStarlight.id("lunar_crystal_special"));
		new ManaCrystalRecipe(EternalStarlight.id("blaze_crystal_special"), CraftingBookCategory.MISC, ManaType.BLAZE, ESItems.BLAZE_CRYSTAL.get()).save(recipeOutput, EternalStarlight.id("blaze_crystal_special"));
		new ManaCrystalRecipe(EternalStarlight.id("light_crystal_special"), CraftingBookCategory.MISC, ManaType.LIGHT, ESItems.LIGHT_CRYSTAL.get()).save(recipeOutput, EternalStarlight.id("light_crystal_special"));
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ESItems.CRESCENT_SPEAR.get())
			...
			.unlockedBy("has_item", has(ESItems.TENACIOUS_PETAL.get()))
			.save(recipeOutput);
		new AccessoryCombinationRecipe(EternalStarlight.id("accessory_combination"), CraftingBookCategory.MISC).save(recipeOutput, EternalStarlight.id("accessory_combination"));
	...
	private <T extends AbstractCookingRecipe> void addCookingRecipes(Consumer<FinishedRecipe> recipeOutput, String name, RecipeSerializer<T> recipeSerializer, int time) {
		simpleCooking(recipeOutput, name, recipeSerializer, time, ESItems.JINGLESTEM_SAPLING.get(), ESItems.JINGLESTEM_CRISP.get(), 0.1F);
		simpleCooking(recipeOutput, name, recipeSerializer, time, ESItems.SPIRAL_KELP.get(), Items.DRIED_KELP, 0.1F);
		simpleCooking(recipeOutput, name, recipeSerializer, time, ESItems.FORGOTTEN_NOCTURNAL_MILLET.get(), ESItems.ROASTED_FORGOTTEN_NOCTURNAL_MILLET.get(), 0.1F);
		simpleCooking(recipeOutput, name, recipeSerializer, time, ESItems.ROOKFISH.get(), ESItems.COOKED_ROOKFISH.get(), 0.35F);
		simpleCooking(recipeOutput, name, recipeSerializer, time, ESItems.LUMINOFISH.get(), ESItems.COOKED_LUMINOFISH.get(), 0.35F);
		simpleCooking(recipeOutput, name, recipeSerializer, time, ESItems.LUMINARIS.get(), ESItems.COOKED_LUMINARIS.get(), 0.35F);
		simpleCooking(recipeOutput, name, recipeSerializer, time, ESItems.AURORA_DEER_STEAK.get(), ESItems.COOKED_AURORA_DEER_STEAK.get(), 0.35F);
		simpleCooking(recipeOutput, name, recipeSerializer, time, ESItems.RATLIN_MEAT.get(), ESItems.COOKED_RATLIN_MEAT.get(), 0.35F);
		simpleCooking(recipeOutput, name, recipeSerializer, time, ESItems.SHADOW_SNAIL_MEAT.get(), ESItems.COOKED_SHADOW_SNAIL_MEAT.get(), 0.35F);
		simpleCooking(recipeOutput, name, recipeSerializer, time, ESItems.LUNARIS_CACTUS_FRUIT.get(), ESItems.LUNARIS_CACTUS_GEL.get(), 0.35F);
	}

	private void addWoodRecipes(Consumer<FinishedRecipe> recipeOutput) {
	...
	private void stonecuttingSet(Consumer<FinishedRecipe> recipeOutput, ItemLike slab, ItemLike stairs, ItemLike wall, ItemLike source) {
	...
	private void addStoneRecipes(Consumer<FinishedRecipe> recipeOutput) {
	...
	private void addThioquartzRecipes(Consumer<FinishedRecipe> recipeOutput) {
	...
	private void addAethersentRecipes(Consumer<FinishedRecipe> recipeOutput) {
	...
	private void addDeepsilverRecipes(Consumer<FinishedRecipe> recipeOutput) {
	...
	private void addUnrealiumRecipes(Consumer<FinishedRecipe> recipeOutput) {
	...
	private void addMalariteRecipes(Consumer<FinishedRecipe> recipeOutput) {
	...
	private void addPungencyFruitRecipes(Consumer<FinishedRecipe> recipeOutput) {
	...
	protected static void pungencyFruitSmithing(Consumer<FinishedRecipe> recipeOutput, Item ingredientItem, RecipeCategory category, Item resultItem) {
	...
	private void addStarfireRecipes(Consumer<FinishedRecipe> recipeOutput) {
	...
	protected final void addStarfireBirdAviary(Consumer<FinishedRecipe> recipeOutput, ItemLike output, ItemLike input) {
	...
	protected static void starfireSmithing(Consumer<FinishedRecipe> recipeOutput, Item ingredientItem, RecipeCategory category, Item resultItem) {
	...
	protected static void flowglazeSmithing(Consumer<FinishedRecipe> recipeOutput, Item ingredientItem, RecipeCategory category, Item resultItem) {
	...
	private void addThermalSpringstoneRecipes(Consumer<FinishedRecipe> recipeOutput) {
	...
	private void addGlaciteRecipes(Consumer<FinishedRecipe> recipeOutput) {
	...
	private void addStarlitDiamondRecipes(Consumer<FinishedRecipe> recipeOutput) {
	...
	private void addStarcoreRecipes(Consumer<FinishedRecipe> recipeOutput) {
		...
		addShapeless(recipeOutput, RecipeCategory.MISC, ESConventionalTags.Items.GEMS_STARCORE, ESItems.CINDER_BRICK.get(), 8, List.of(Items.LAVA_BUCKET), List.of(ESConventionalTags.Items.GEMS_STARCORE, ESConventionalTags.Items.GEMS_STARCORE, Tags.Items.GRAVEL, Tags.Items.GRAVEL, Tags.Items.GRAVEL, Tags.Items.GRAVEL));	}

	private void addSaltpeterRecipes(Consumer<FinishedRecipe> recipeOutput) {
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, ESItems.SALTPETER_MATCHBOX.get())
			...
			.save(recipeOutput);
		new ToolModificationRecipe(EternalStarlight.id("torch_from_saltpeter_matchbox"), CraftingBookCategory.MISC, ESItems.SALTPETER_MATCHBOX.get(), Items.STICK, new ItemStack(Items.TORCH, 4)).save(recipeOutput, EternalStarlight.id("torch_from_saltpeter_matchbox"));
	}

	private void addAmaramberRecipes(Consumer<FinishedRecipe> recipeOutput) {
	...
	// misc
	protected final void addSmelt(Consumer<FinishedRecipe> recipeOutput, int time, ItemLike criteria, ItemLike output, ItemLike... input) {
		addSmelt(recipeOutput, RecipeCategory.MISC, time, criteria, output, input);
	}

	protected final void addSmelt(Consumer<FinishedRecipe> recipeOutput, RecipeCategory category, int time, ItemLike criteria, ItemLike output, ItemLike... input) {
	...
	protected final void addBlast(Consumer<FinishedRecipe> recipeOutput, int time, ItemLike criteria, ItemLike output, ItemLike... input) {
	...
	protected final void addShapeless(Consumer<FinishedRecipe> recipeOutput, ItemLike criteria, ItemLike output, int num, ItemLike... ingredients) {
		addShapeless(recipeOutput, RecipeCategory.MISC, criteria, output, num, ingredients);
	}

	protected final void addShapeless(Consumer<FinishedRecipe> recipeOutput, RecipeCategory category, ItemLike criteria, ItemLike output, int num, ItemLike... ingredients) {
		addShapeless(recipeOutput, category, "", criteria, output, num, ingredients);
	}

	protected final void addShapeless(Consumer<FinishedRecipe> recipeOutput, RecipeCategory category, String nameSuffix, ItemLike criteria, ItemLike output, int num, ItemLike... ingredients) {
	...
	protected final void addShapeless(Consumer<FinishedRecipe> recipeOutput, RecipeCategory category, TagKey<Item> criteria, ItemLike output, int num, List<ItemLike> ingredients, List<TagKey<Item>> tags) {
		ShapelessRecipeBuilder builder = ShapelessRecipeBuilder.shapeless(category, output, num);
		for (ItemLike item : ingredients) {
			builder.requires(item);
		}
	...
	// combat & tools
	protected final void addHelmet(Consumer<FinishedRecipe> recipeOutput, ItemLike output, TagKey<Item> input) {
	...
	protected final void addChestplate(Consumer<FinishedRecipe> recipeOutput, ItemLike output, TagKey<Item> input) {
		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, output)
			.pattern("# #")
			.pattern("###")
			.pattern("###")
	...
	protected final void addLeggings(Consumer<FinishedRecipe> recipeOutput, ItemLike output, TagKey<Item> input) {
		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, output)
			.pattern("###")
			.pattern("# #")
			.pattern("# #")
	...
	protected final void addBoots(Consumer<FinishedRecipe> recipeOutput, ItemLike output, TagKey<Item> input) {
		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, output)
			.pattern("# #")
			.pattern("# #")
			.define('#', input)
	...
	protected final void addScythe(Consumer<FinishedRecipe> recipeOutput, ItemLike output, TagKey<Item> input) {
		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, output)
			.pattern("###")
			.pattern("  H")
			.pattern("  H")
	...
	protected final void addSickle(Consumer<FinishedRecipe> recipeOutput, ItemLike output, TagKey<Item> input) {
	...
	protected final void addHoe(Consumer<FinishedRecipe> recipeOutput, ItemLike output, TagKey<Item> input) {
		ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, output)
			.pattern("##")
			.pattern(" H")
			.pattern(" H")
	...
	protected final void addShovel(Consumer<FinishedRecipe> recipeOutput, ItemLike output, TagKey<Item> input) {
		ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, output)
			.pattern("#")
			.pattern("H")
			.pattern("H")
	...
	protected final void addPickaxe(Consumer<FinishedRecipe> recipeOutput, ItemLike output, TagKey<Item> input) {
		ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, output)
			.pattern("###")
			.pattern(" H ")
			.pattern(" H ")
	...
	protected final void addSword(Consumer<FinishedRecipe> recipeOutput, ItemLike output, ItemLike input) {
		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, output)
			.pattern("#")
			.pattern("#")
			.pattern("H")
	...
	protected final void addSword(Consumer<FinishedRecipe> recipeOutput, ItemLike output, TagKey<Item> input) {
		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, output)
			.pattern("#")
			.pattern("#")
			.pattern("H")
	...
	protected final void addAxe(Consumer<FinishedRecipe> recipeOutput, ItemLike output, TagKey<Item> input) {
		ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, output)
			.pattern("##")
			.pattern("#H")
			.pattern(" H")
	...
	protected final void addHammer(Consumer<FinishedRecipe> recipeOutput, ItemLike output, TagKey<Item> input) {
		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, output)
			.pattern("###")
			.pattern("#H#")
			.pattern(" H ")
	...
	protected final void addSpear(Consumer<FinishedRecipe> recipeOutput, ItemLike output, TagKey<Item> input) {
		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, output)
			.pattern("  #")
			.pattern(" H ")
			.pattern("H  ")
	...
	protected final void addWhip(Consumer<FinishedRecipe> recipeOutput, ItemLike output, ItemLike input) {
		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, output)
			.pattern("###")
			.pattern("  H")
			.define('#', input)
	...
	protected final void addWhip(Consumer<FinishedRecipe> recipeOutput, ItemLike output, TagKey<Item> input) {
		ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, output)
			.pattern("###")
			.pattern("  H")
			.define('#', input)
	...
	protected final void addPlanks(Consumer<FinishedRecipe> recipeOutput, Block output, TagKey<Item> input) {
	...
	protected final void addWood(Consumer<FinishedRecipe> recipeOutput, Block output, Block input) {
	...
	protected final void addStrippedWood(Consumer<FinishedRecipe> recipeOutput, Block output, Block input) {
		ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, output, 3)
			.pattern("##")
			.pattern("##")
			.define('#', input)
	...
	protected final void addButton(Consumer<FinishedRecipe> recipeOutput, Block output, Block input) {
	...
	protected final void addDoor(Consumer<FinishedRecipe> recipeOutput, Block output, Block input) {
	...
	protected final void addFence(Consumer<FinishedRecipe> recipeOutput, Block output, Block input) {
		ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, output, 3)
			.pattern("#S#")
			.pattern("#S#")
			.define('#', input)
	...
	protected final void addFenceGate(Consumer<FinishedRecipe> recipeOutput, Block output, Block input) {
	...
	protected final void addPressurePlate(Consumer<FinishedRecipe> recipeOutput, Block output, Block input) {
		ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, output)
			.pattern("##")
			.define('#', input)
			.unlockedBy("has_item", has(input))
	...
	protected final void addPillar(Consumer<FinishedRecipe> recipeOutput, Block output, Block input) {
	...
	protected final void addTrapdoor(Consumer<FinishedRecipe> recipeOutput, Block output, Block input) {
	...
	protected final void addSign(Consumer<FinishedRecipe> recipeOutput, ItemLike output, Block input) {
	...
	protected final void addBoat(Consumer<FinishedRecipe> recipeOutput, Item boat, Item chestBoat, Block planks) {
	...
	protected void colorWithDye(Consumer<FinishedRecipe> recipeOutput, List<Item> dyes, List<Item> toDye, String name) {
	...
	protected void customCarpet(Consumer<FinishedRecipe> recipeOutput, ItemLike output, ItemLike input) {
	...
	protected void bed(Consumer<FinishedRecipe> recipeOutput, ItemLike output, ItemLike input) {
	...
	protected <T extends AbstractCookingRecipe> void simpleCooking(Consumer<FinishedRecipe> recipeOutput, String fromName, RecipeSerializer<T> serializer, int time, ItemLike input, ItemLike output, float xp) {
		SimpleCookingRecipeBuilder.generic(Ingredient.of(input), RecipeCategory.FOOD, output, xp, time, serializer)
			.unlockedBy(getHasName(input), has(input))
			.save(recipeOutput, EternalStarlight.id(getItemName(output) + "_from_" + fromName));
	}

	protected static void copySmithingTemplate(Consumer<FinishedRecipe> recipeOutput, ItemLike template, ItemLike ingredient, TagKey<Item> ingotIngredient) {
	...
	public static Stream<TrimTemplate> smithingTrims() {
		return Stream.of(ESItems.KEEPER_ARMOR_TRIM_SMITHING_TEMPLATE.get(), ESItems.FORGE_ARMOR_TRIM_SMITHING_TEMPLATE.get(), ESItems.BLOOMING_ARMOR_TRIM_SMITHING_TEMPLATE.get(), ESItems.TWINING_ARMOR_TRIM_SMITHING_TEMPLATE.get()).map((item) -> new TrimTemplate(item, EternalStarlight.id(getItemName(item) + "_smithing_trim")));
	}
