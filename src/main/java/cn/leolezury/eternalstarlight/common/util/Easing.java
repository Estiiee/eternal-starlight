...
public interface Easing {
	...
	static Easing readFromNetwork(FriendlyByteBuf buf) {
		String name = buf.readUtf();
		return EASINGS.getOrDefault(name, IDENTITY);
	}

	default void writeToNetwork(FriendlyByteBuf buf) {
		String name = EASINGS.entrySet().stream()
